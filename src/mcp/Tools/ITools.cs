...
public interface ITool
{
    ...
    BudgetEstimate BudgetEstimatorTool(string visitsPerCategoryJson, decimal perMealEur = 15m);
    ...
    BookingResult BookingApiSimulator(string provider, string itemType, string detailsJson);
